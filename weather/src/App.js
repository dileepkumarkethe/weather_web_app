  ...
  render() {
    ...
    return (
      <div className='App'>
        ...
        <div className='about'>
        <h2>ABOUT!!!</h2>
      <p>This weather web app gives you details about
         weather conditions at your location or at any place around the world. 
         Type in the input area with your place and then  press enter button 
         and To know more about the place searched, click on the name of the place.</p><br></br>
         <p> Happy usage 😊</p><br></br>
          <p>© Dileepkumar Kethe</p>
       </div>
      </div>
    );
  }
